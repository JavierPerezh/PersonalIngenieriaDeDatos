...
-- Ejercicio 4 del preparcial
-- Parte a)

insert into consultas (medico_id, paciente_id, fecha_consulta, diagnostico, costo, estado) 
values (3,5,curdate(), 'Control pediatrico',90000, 'programada');

-- Parte b)

update consultas set estado = 'realizada' where consulta_id = last_insert_id();
